...
class Processor(LooseAtom):
    @staticmethod
    def get_ext():
        return '.processor'
    
    def __init__(self, func=None, save_path=None, load_path=None):
        super().__init__(func, save_path, load_path)
    ...
    def process(self, input_data):
        return self.get_data()(input_data)
    # @classmethod
...
# if __name__ == '__main__':
    # save_path = 'D:/documents/AcademicDocuments/customed_python_pkgs/loosely/test/test.processor'
    # def a(x):
    #     return x+1

    # processor = Processor(a, save_path)
    # print(processor.save_path)
    # processor.save_to_disk()
    # processor = Processor.load_from_disk(save_path)
